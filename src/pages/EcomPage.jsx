        ...
        <div style={{paddingBottom: '30px'}}>
            ...
            <div>
                ...
                <Container maxWidth="lg" className={clsx(classes.introduction, classes.container)}>
                    ...
                    <Grid container spacing={3}>
                        <Grid item sm={8}>
                            ...
                            <Typography variant="body1" paragraph gutterBottom>This project was built using React.js and Material UI for the frontend. All the magic behind the scenes is handled with Express.js and payments are securely managed by Stripe.</Typography>
                ...
                <Container maxWidth="lg" className={classes.container}>
                    ...
                    <Typography variant="body1" paragraph gutterBottom>Last but not least, Admin Routes. As I have already mention, admin has a few unique tools in order to manage the site from frontend. And that's the situation when I use these type of routes. A user must be an admin to be able to access them. This component is built very much the same way as the previous routes. The only difference is that I am no longer checking for authenticated, though for admin state.</Typography>                
                </Container>
